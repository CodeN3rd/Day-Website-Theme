# Day Responsive Website Template
Day template setup for new clients who want a basic information website from FAI Marketing Inc.

## Setup Day ##
_Here are the steps to install Day on Clients Server_
```
